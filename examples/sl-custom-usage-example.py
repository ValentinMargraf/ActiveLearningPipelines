...
from ALP.pipeline.Labeler import HighestConfidenceLabeler, CoLearningLabeler
...
scenario = benchmark_connector.load_or_create_scenario(openml_id=61, train_split_seed=1337, test_split_seed=42, seed=0,
