...
class TabPFNClassifierEns(BaseEstimator, ClassifierMixin):
    models_in_memory = {}
...
def transformer_predict(
    ...
    **kwargs,
    ...
    for i, ensemble_configuration in enumerate(ensemble_configurations):
        ...
        output_ = torch.cat(
            [output_[..., class_shift_configuration:], output_[..., :class_shift_configuration]], dim=-1
        )
    ...
    # list of array into array of arrays
    out = np.concatenate(outputs_list, axis=1)
    return out
