...
class StatisticalPerformanceObserver(Observer, ABC):
    ...
    def compute_labeling_statistics(self, iteration, X_u_selected, y_u_selected, X_l_aug, y_l_aug, X_u_red, D_l_ind):
        """
...
class PrintObserver(StatisticalPerformanceObserver):
    ...
    def observe_data(self, iteration, X_u_selected, y_u_selected, X_l_aug, y_l_aug, X_u_red, D_l_ind):
        ...
        Parameters:
            ...
            D_l_ind (np.array): Indices of X_u selected to be labeled
        """
        super().compute_labeling_statistics(iteration, X_u_selected, y_u_selected, X_l_aug, y_l_aug, X_u_red, D_l_ind)
