...
class SALTEvaluator:
    def __init__(self, benchmark_connector: BenchmarkConnector, setting_name=None, learner_name=None,
                 sampling_strategy_name=None, openml_id=None, test_split_seed=0, train_split_seed=0, seed=0):
    ...
    def _load_setting_and_scenario(self):
        ...
        self.scenario = self.benchmark_connector.load_or_create_scenario(openml_id=self.openml_id,
