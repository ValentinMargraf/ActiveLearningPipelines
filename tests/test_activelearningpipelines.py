...
def test_pipeline_executions():
    ...
    sampling_strategies = [
        RandomSamplingStrategy(42),
        EntropySampling(42),
        MarginSampling(42),
        LeastConfidentSampling(42),
        MonteCarloEERLogLoss(42),
        MonteCarloEERMisclassification(42),
        DiscriminativeSampling(42),
        QueryByCommitteeEntropySampling(42, 10),
        QueryByCommitteeKLSampling(42, 10),
        BatchBaldSampling(42, 10),
        PowerMarginSampling(42),
        RandomMarginSampling(42),
        MinMarginSampling(42),
        ExpectedAveragePrecision(42),
        TypicalClusterSampling(42),
